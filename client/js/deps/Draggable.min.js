			...
			Draggable = function(target, vars) {
				...
				var type = (vars.type || (_isOldIE ? "top,left" : "x,y")).toLowerCase(),
					...
					onMove = function(e,smooth){
						...
						if(self.smooth > 0){
							self.tweenX = self.pointerX;
							self.tweenY = self.pointerY;
							TweenLite.to(self,self.smooth,{
								tweenX:e.clientX-self.ratio,
								tweenY:e.clientY-self.ratio,
								onUpdate: function(){
									setPointerPosition(self.tweenX, self.tweenY);
								}.bind(this)
							});
						}else{
				...
				self.smooth = false;
				this.enableTween =function(t,r){
					self.ratio = r || 0;
					self.tweenX = 0;
					self.tweenY = 0;
					self.smooth = t;
				}
				this.disableTween = function(){
					self.smooth = 0;
				}
